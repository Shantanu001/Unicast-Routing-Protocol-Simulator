...
public class MainActivity extends JFrame {
	...
	String row[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } }; // routing table values
	String row1[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String row2[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String row3[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String row4[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String row5[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String dups_row[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } }; // duplicate table to initialise the vlaues
	String dups_row1[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String dups_row2[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String dups_row3[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String dups_row4[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	String dups_row5[][] = { { "1", "999", "" }, { "2", "999", "" }, { "3", "999", "" }, { "4", "999", "" },
			{ "5", "999", "" }, { "6", "999", "" } };
	JPanel p2;
	JPanel p3;
	...
	MainActivity() {
		...
		((JSpinner.DefaultEditor) spin.getEditor()).getTextField().setEditable(false);// Disabling spinner from getting
																						// edited
		...
		n_num.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				num_nodes = (Integer) n_num.getValue();
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (count <= edg) {
					...
					if (x_value == 1) // Setting the values of initial routing table
					{
						...
						if (y_value == 2) {
							row1[x_value - 1][1] = String.valueOf(1);
							row1[x_value - 1][2] = row1[x_value - 1][0];
						}
						if (y_value == 3) {
							row2[x_value - 1][1] = String.valueOf(1);
							row2[x_value - 1][2] = row2[x_value - 1][0];
						}
						if (y_value == 4) {
							row3[x_value - 1][1] = String.valueOf(1);
							row3[x_value - 1][2] = row3[x_value - 1][0];
						}
						if (y_value == 5) {
							row4[x_value - 1][1] = String.valueOf(1);
							row4[x_value - 1][2] = row4[x_value - 1][0];
						}
						if (y_value == 6) {
							row5[x_value - 1][1] = String.valueOf(1);
							row5[x_value - 1][2] = row5[x_value - 1][0];
						}
					}
					if (x_value == 2) {
						row1[y_value - 1][1] = String.valueOf(1);
						row1[y_value - 1][2] = row[y_value - 1][0];
						if (y_value == 1) {
							row[x_value - 1][1] = String.valueOf(1);
					...
					if (x_value == 3) {
						row2[y_value - 1][1] = String.valueOf(1);
						row2[y_value - 1][2] = row2[y_value - 1][0];
						if (y_value == 2) {
							row1[x_value - 1][1] = String.valueOf(1);
							row1[x_value - 1][2] = row1[x_value - 1][0];
						}
					...
					{
						row3[y_value - 1][1] = String.valueOf(1);
						row3[y_value - 1][2] = row3[y_value - 1][0];
						if (y_value == 2) {
							row1[x_value - 1][1] = String.valueOf(1);
							row1[x_value - 1][2] = row1[x_value - 1][0];
						}
					...
					if (x_value == 5) {
						row4[y_value - 1][1] = String.valueOf(1);
						row4[y_value - 1][2] = row4[y_value - 1][0];
						if (y_value == 2) {
							row1[x_value - 1][1] = String.valueOf(1);
							row1[x_value - 1][2] = row1[x_value - 1][0];
						}
						...
						if (y_value == 4) {
							row3[x_value - 1][1] = String.valueOf(1);
							row3[x_value - 1][2] = row1[x_value - 1][0];
						}
						if (y_value == 1) {
							row[x_value - 1][1] = String.valueOf(1);
							row[x_value - 1][2] = row[x_value - 1][0];
					...
					if (x_value == 6) {
						row5[y_value - 1][1] = String.valueOf(1);
						row5[y_value - 1][2] = row5[y_value - 1][0];
						if (y_value == 2) {
							row1[x_value - 1][1] = String.valueOf(1);
							row1[x_value - 1][2] = row1[x_value - 1][0];
						}
		...
		protocol.add(bgp);
		protocol.add(ospf);
		protocol.add(protocol_cmp); // adding menuitems to protocol
		mb.add(file);
		file.addSeparator();
		mb.add(protocol);
		...
		rip.addActionListener(new ActionListener() { // Adding new window to for rip protocol
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for(i=num_nodes;i<6;i++)
				{
					tb.getModel().setValueAt("",i,0);  
					tb.getModel().setValueAt("",i,1);  
					tb1.getModel().setValueAt("",i,0);  
					tb1.getModel().setValueAt("",i,1);  
					tb2.getModel().setValueAt("",i,0);  
					tb2.getModel().setValueAt("",i,1); 
					tb3.getModel().setValueAt("",i,0);  
					tb3.getModel().setValueAt("",i,1);  
					tb4.getModel().setValueAt("",i,0);  
					tb4.getModel().setValueAt("",i,1);  
					tb5.getModel().setValueAt("",i,0);  
					tb5.getModel().setValueAt("",i,1); 
				...
				cal.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						// TODO Auto-generated method stub
						rip_x = Integer.parseInt(input1.getText()); // To calculate the routing table after
																	// communicating with the specified routing table
							...
							if (rip_y == 2) {
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(row1[i][1])
												+ Integer.parseInt(row[rip_y - 1][1])) < (Integer
														.parseInt(row[i][1]))) {
								...
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(row[i][1])
												+ Integer.parseInt(row1[rip_y - 1][1])) < (Integer
														.parseInt(row1[i][1]))) {
							...
							if (rip_y == 1) {
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(row[i][1])
												+ Integer.parseInt(row2[rip_y - 1][1])) < (Integer
														.parseInt(row2[i][1]))) {
							...
							if (rip_y == 1) {
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(row[i][1])
												+ Integer.parseInt(row3[rip_y - 1][1])) < (Integer
														.parseInt(row3[i][1]))) {
							...
							if (rip_y == 1) {
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(row[i][1])
												+ Integer.parseInt(row4[rip_y - 1][1])) < (Integer
														.parseInt(row4[i][1]))) {
							...
							if (rip_y == 1) {
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(row[i][1])
												+ Integer.parseInt(row5[rip_y - 1][1])) < (Integer
														.parseInt(row5[i][1]))) {
				...
				//Implementing rip protocol on single button click
				fin.setBounds(100, 250, 150, 30);
				fin.addActionListener(new ActionListener() { // Adding function to calculate the final RIP of the
																// routing table
					...
					public void actionPerformed(ActionEvent e) {
						...
						int val1 = 0;
						rip_x = 1;
						for (rip_y = 1; rip_y <= num_nodes; rip_y++) {
							if (rip_y == rip_x) {
								continue;
							} else {
								for (i = 0; i < num_nodes; i++) {
									...
									if ((i + 1) == rip_x) {
										...
										/*
										 * if(rip_y==6)
										 * {System.out.println("value:- "+dup_row[rip_y-1][i][1]+" "+dup_row[0][rip_y-1]
										 * [1]+"compare to  :- "+dup_row[0][i][1]);}
										 */
										if ((Integer.parseInt(dup_row[rip_y - 1][i][1])
												+ Integer.parseInt(dup_row[0][rip_y - 1][1])) < (Integer
														.parseInt(dup_row[0][i][1]))) {

											val1 = Integer.parseInt(dup_row[rip_y - 1][i][1])
													+ Integer.parseInt(dup_row[0][rip_y - 1][1]);
							...
							if (rip_y == rip_x) {
								...
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(dup_row[rip_y - 1][i][1])
												+ Integer.parseInt(dup_row[1][rip_y - 1][1])) < (Integer
														.parseInt(dup_row[1][i][1]))) {

											val1 = Integer.parseInt(dup_row[rip_y - 1][i][1])
													+ Integer.parseInt(dup_row[1][rip_y - 1][1]);
							...
							if (rip_y == rip_x) {
								...
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(dup_row[rip_y - 1][i][1])
												+ Integer.parseInt(dup_row[2][rip_y - 1][1])) < (Integer
														.parseInt(dup_row[2][i][1]))) {

											val1 = Integer.parseInt(dup_row[rip_y - 1][i][1])
													+ Integer.parseInt(dup_row[2][rip_y - 1][1]);
							...
							if (rip_y == rip_x) {
								...
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(dup_row[rip_y - 1][i][1])
												+ Integer.parseInt(dup_row[3][rip_y - 1][1])) < (Integer
														.parseInt(dup_row[3][i][1]))) {

											val1 = Integer.parseInt(dup_row[rip_y - 1][i][1])
													+ Integer.parseInt(dup_row[3][rip_y - 1][1]);
							...
							for (i = 0; i < num_nodes; i++) {
								if (rip_y == rip_x) {
									...
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(dup_row[rip_y - 1][i][1])
												+ Integer.parseInt(dup_row[4][rip_y - 1][1])) < (Integer
														.parseInt(dup_row[4][i][1]))) {

											val1 = Integer.parseInt(dup_row[rip_y - 1][i][1])
													+ Integer.parseInt(dup_row[4][rip_y - 1][1]);
							...
							if (rip_y == rip_x) {
								...
								for (i = 0; i < num_nodes; i++) {
									if ((i + 1) == rip_x) {
										...
										if ((Integer.parseInt(dup_row[rip_y - 1][i][1])
												+ Integer.parseInt(dup_row[5][rip_y - 1][1])) < (Integer
														.parseInt(dup_row[5][i][1]))) {

											val1 = Integer.parseInt(dup_row[rip_y - 1][i][1])
													+ Integer.parseInt(dup_row[5][rip_y - 1][1]);
						...
						tb.getModel().setValueAt("-", 0, 1);
						tb1.getModel().setValueAt("-", 1, 1);
						tb2.getModel().setValueAt("-", 2, 1);
						tb3.getModel().setValueAt("-", 3, 1);
						tb4.getModel().setValueAt("-", 4, 1);
						tb5.getModel().setValueAt("-", 5, 1);
					}
				});
				
				//Closing the RIP HANDLER
				...
				for(int m=num_nodes;m<6;m++)
				{
					if(m==5) {jp5.setVisible(false);}
					if(m==4) {jp4.setVisible(false);}
					if(m==3) {jp3.setVisible(false);}
					if(m==2) {jp2.setVisible(false);}
					if(m==1) {jp1.setVisible(false);}
					if(m==0) {jp.setVisible(false);}
				}
			}
		});
				...
				cal_Ospf.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						for (int ed = 1; ed <= (Integer) n_num.getValue(); ed++) {
							if (ed == ospf_source || neigh[ed] == ospf_source) {
								neigh[ed] = 0;
								continue;
							} else {
		...
		//Implementing protocol comparison between RIP AND OSPF
